...
{
    internal void GenericCountMethodDoubles()
    {
    ...
    internal void GenericCountMethodStrings()
    {
    ...
    internal void GenericSwapMethodIntegers()
    {
    ...
    internal void GenericSwapMethodStrings()
    {
    ...
    private void Swap<T>(IList<T> collection, int indexToSwap, int swapWithIndex)
    {
    ...
    internal void GenericBoxOfInteger()
    {
        var numberOfIntegers = int.Parse(Console.ReadLine());
    ...
    internal void GenericBoxOfString()
    {
        var numberOfStrings = int.Parse(Console.ReadLine());
